import { getBorderPoints, getBoundsFromBorderPoints, getCenterFromBounds, getCenterFromGrid } from './math';
...
const getCenterPoint = (grid) => {
    let center;
    if (grid.projection) {
        const projection = new DynamicProjection(grid.projection.name, grid.projection);
...
export const getDomainOptions = (domainName) => {
    const optGroups = {};
